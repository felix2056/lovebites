            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 product-single-gallery">
                    <div class="product-slider-container">
                        ...
                        <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                            <div class="product-item">
                                <img class="product-single-image" src="/images/product-1-big_1.jpg" data-zoom-image="assets/images/products/zoom/product-1-big.jpg" width="468" height="468" alt="product">
                            </div>
                            <div class="product-item">
                                <img class="product-single-image" src="/images/product-2-big_1.jpg" data-zoom-image="assets/images/products/zoom/product-2-big.jpg" width="468" height="468" alt="product">
                            </div>
                            <div class="product-item">
                                <img class="product-single-image" src="/images/product-3-big_1.jpg" data-zoom-image="assets/images/products/zoom/product-3-big.jpg" width="468" height="468" alt="product">
                            </div>
                            <div class="product-item">
                                <img class="product-single-image" src="/images/product-4-big_1.jpg" data-zoom-image="assets/images/products/zoom/product-4-big.jpg" width="468" height="468" alt="product">
                            </div>
                            <div class="product-item">
                                <img class="product-single-image" src="/images/product-5-big_1.jpg" data-zoom-image="assets/images/products/zoom/product-5-big.jpg" width="468" height="468" alt="product">
                            </div>
                        </div>
                    ...
                    <div class="prod-thumbnail owl-dots">
                        <div class="owl-dot">
                            <img src="/images/product-1_4.jpg" width="110" height="110" alt="product-thumbnail">
                        </div>
                        <div class="owl-dot">
                            <img src="/images/product-2_3.jpg" width="110" height="110" alt="product-thumbnail">
                        </div>
                        <div class="owl-dot">
                            <img src="/images/product-3_3.jpg" width="110" height="110" alt="product-thumbnail">
                        </div>
                        <div class="owl-dot">
                            <img src="/images/product-4_5.jpg" width="110" height="110" alt="product-thumbnail">
                        </div>
                        <div class="owl-dot">
                            <img src="/images/product-5_3.jpg" width="110" height="110" alt="product-thumbnail">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="product-nav">
                            ...
                            <a href="#">
                                ...
                                <span class="product-popup">
                                    <span class="box-content">
                                        <img alt="product" width="150" height="150" src="/images/product-3.jpg" style="padding-top: 0px;">
                        ...
                        <div class="product-next">
                            <a href="#">
                                ...
                                <span class="product-popup">
                                    <span class="box-content">
                                        <img alt="product" width="150" height="150" src="/images/product-4_3.jpg" style="padding-top: 0px;">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="product-size-content" role="tabpanel" aria-labelledby="product-tab-size">
                    <div class="product-size-content">
                        <div class="row">
                            <div class="col-md-4">
                                <img src="/images/body-shape.png" alt="body shape" width="217" height="398">
                            </div>
                            <!-- End .col-md-4 -->
        ...
        <div class="products-section pt-0">
            ...
            <div class="products-slider 5col owl-carousel owl-theme dots-top dots-small">
                <div class="product-default inner-quickview inner-icon">
                    <figure class="img-effect">
                        <a href="demo1-product.html">
                            <img src="/images/product-1_9.jpg" width="205" height="205" alt="product">
                            <img src="/images/product-1-2_2.jpg" width="205" height="205" alt="product">
                        </a>
                        <div class="label-group">
                            <div class="product-label label-hot">HOT</div>
                ...
                <div class="product-default inner-quickview inner-icon">
                    <figure class="img-effect">
                        <a href="demo1-product.html">
                            <img src="/images/product-2_8.jpg" width="205" height="205" alt="product">
                        </a>
                        <div class="btn-icon-group">
                ...
                <div class="product-default inner-quickview inner-icon">
                    <figure class="img-effect">
                        <a href="demo1-product.html">
                            <img src="/images/product-3_7.jpg" width="205" height="205" alt="product">
                            <img src="/images/product-3-2_3.jpg" width="205" height="205" alt="product">
                        </a>
                        <div class="btn-icon-group">
                            <a href="#" class="btn-icon btn-add-cart product-type-simple"><i class="icon-shopping-cart"></i></a>
                        </div>
                ...
                <div class="product-default inner-quickview inner-icon">
                    <figure class="img-effect">
                        <a href="demo1-product.html">
                            <img src="/images/product-4_8.jpg" width="205" height="205" alt="product">
                            <img src="/images/product-4-2_3.jpg" width="205" height="205" alt="product">
                        </a>
                        <div class="btn-icon-group">
                            <a href="#" class="btn-icon btn-add-cart product-type-simple"><i class="icon-shopping-cart"></i></a>
                        </div>
                ...
                <div class="product-default inner-quickview inner-icon">
                    <figure class="img-effect">
                        <a href="demo1-product.html">
                            <img src="/images/product-5_5.jpg" width="205" height="205" alt="product">
                            <img src="/images/product-5-2_3.jpg" width="205" height="205" alt="product">
                        </a>
                        <div class="btn-icon-group">
                            <a href="demo1-product.html" class="btn-icon btn-add-cart"><i class="fa fa-arrow-right"></i>
                            </a>
        ...
        <div class="product-widgets-container row pb-2">
            <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="demo1-product.html">
                            <img src="/images/product-1_3.jpg" width="74" height="74" alt="product">
                            <img src="/images/product-1-2_1.jpg" width="74" height="74" alt="product">
                        </a>
                    </figure>
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="demo1-product.html">
                            <img src="/images/product-2_2.jpg" width="74" height="74" alt="product">
                            <img src="/images/product-2-2_1.jpg" width="74" height="74" alt="product">
                        </a>
                    </figure>
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="demo1-product.html">
                            <img src="/images/product-3_2.jpg" width="74" height="74" alt="product">
                            <img src="/images/product-3-2_1.jpg" width="74" height="74" alt="product">
                        </a>
                    </figure>
            ...
            <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="demo1-product.html">
                            <img src="/images/product-4_4.jpg" width="74" height="74" alt="product">
                            <img src="/images/product-4-2_1.jpg" width="74" height="74" alt="product">
                        </a>
                    </figure>
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="demo1-product.html">
                            <img src="/images/product-5_2.jpg" width="74" height="74" alt="product">
                            <img src="/images/product-5-2_1.jpg" width="74" height="74" alt="product">
                        </a>
                    </figure>
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="demo1-product.html">
                            <img src="/images/product-6_2.jpg" width="74" height="74" alt="product">
                            <img src="/images/product-6-2_1.jpg" width="74" height="74" alt="product">
                        </a>
                    </figure>
            ...
            <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="demo1-product.html">
                            <img src="/images/product-7_2.jpg" width="74" height="74" alt="product">
                            <img src="/images/product-7-2_1.jpg" width="74" height="74" alt="product">
                        </a>
                    </figure>
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="demo1-product.html">
                            <img src="/images/product-8_2.jpg" width="74" height="74" alt="product">
                            <img src="/images/product-8-2_1.jpg" width="74" height="74" alt="product">
                        </a>
                    </figure>
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="demo1-product.html">
                            <img src="/images/product-9_2.jpg" width="74" height="74" alt="product">
                            <img src="/images/product-9-2_1.jpg" width="74" height="74" alt="product">
                        </a>
                    </figure>
            ...
            <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="demo1-product.html">
                            <img src="/images/product-10_3.jpg" width="74" height="74" alt="product">
                            <img src="/images/product-10-2_1.jpg" width="74" height="74" alt="product">
                        </a>
                    </figure>
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="demo1-product.html">
                            <img src="/images/product-11_2.jpg" width="74" height="74" alt="product">
                            <img src="/images/product-11-2_1.jpg" width="74" height="74" alt="product">
                        </a>
                    </figure>
                ...
                <div class="product-default left-details product-widget">
                    <figure>
                        <a href="demo1-product.html">
                            <img src="/images/product-12_1.jpg" width="74" height="74" alt="product">
                            <img src="/images/product-12-2_1.jpg" width="74" height="74" alt="product">
                        </a>
                    </figure>
